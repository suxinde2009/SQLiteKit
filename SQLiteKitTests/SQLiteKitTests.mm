...
#import <SQLiteKit/SQLiteKit.h>

#ifdef SQLITE_KIT_ENABLE_ASSERT_HANDLER
namespace SQLite
{
/// definition of the assertion handler enabled when SQLITE_KIT_ENABLE_ASSERT_HANDLER is defined in the project (CMakeList.txt)
...
//  std::cout << "SQlite3 version " << SQLITE_VERSION << std::endl;
    ...
    std::cout << "SQliteKit version " << SQLITE_KIT_VERSION << std::endl;
    ...
    try
    {
        ...
        if (NULL != fp)
        {
            ...
            if (query.executeStep())
            {
                ...
                SQLITE_KIT_ASSERT(sizew == size, "fwrite failed");   // See SQLITE_KIT_ENABLE_ASSERT_HANDLER
                fclose (fp);
            }
        }
        else
